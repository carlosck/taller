...
// GlobalConfig::$CONNECTION_SETTING->DBName = "taller";
// GlobalConfig::$CONNECTION_SETTING->Username = "root";
// GlobalConfig::$CONNECTION_SETTING->Password = "";

GlobalConfig::$CONNECTION_SETTING->DBName = "rdy_inventario";
GlobalConfig::$CONNECTION_SETTING->Username = "rdy";
GlobalConfig::$CONNECTION_SETTING->Password = "cD;@;6B3fclt";
...
/** the root url of the application with trailing slash, for example http://localhost/total sound/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'taller/';
