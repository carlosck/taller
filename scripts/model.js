/**
 * backbone model definitions for Total Sound
 */
 ...
 * Caja Backbone Model
 */
model.CajaModel = Backbone.Model.extend({
	urlRoot: 'api/caja',
	idAttribute: 'id',
	id: '',
	nombre: '',
...
/**
 * Caja Backbone Collection
 */
model.CajaCollection = model.AbstractCollection.extend({
	url: 'api/cajas',
...
/**
 * Seccion Backbone Model
 */
model.SeccionModel = Backbone.Model.extend({
	urlRoot: 'api/seccion',
	idAttribute: 'id',
	id: '',
	nombre: '',
...
/**
 * Seccion Backbone Collection
 */
model.SeccionCollection = model.AbstractCollection.extend({
	url: 'api/secciones',
	model: model.SeccionModel
});

/**
 * Venta Backbone Model
 */
model.VentaModel = Backbone.Model.extend({
	urlRoot: 'api/venta',
	idAttribute: 'id',
	id: '',
	productoId: '',
...
/**
 * Venta Backbone Collection
 */
model.VentaCollection = model.AbstractCollection.extend({
	url: 'api/ventas',
	model: model.VentaModel
});
